    ...
    return (
        ...
        >
            ...
            {item.mediaFiles.length ? (
                <Pressable
                    onPress={() =>
                        navigation.navigate("imagesPost", {
                        ...
                        >
                            ...
                            {item.mediaFiles.length > 1 ? (
                                ...
                                >
                                    <Image
                                        source={{
                                            uri: item.mediaFiles[1].location,
                                        }}
                                        style={{ flex: 1 }}
                                    />
