...
const ChatScreen = (navigation, route) => {
    ...
    //         // const chatRooms = chatRoomsData.data.map((chatroomData) => {
    //         //     const { _id, members, lastMessage, lastMessageTime } =
    //         //         chatroomData;
    //         //     const receiver = members.find((member) => member._id !== uid);
                ...
                <View style={{ flex: 1, height: "100%" }}>
                    <View style={{ flexDirection: "row" }}>
                        ...
                        <Text style={styles.roomTime}>
                            {" "}
                            {item.lastMessage
                                ? getTimeToNow(item.lastMessageTime)
                                : "12h"}
                        </Text>
                    </View>
